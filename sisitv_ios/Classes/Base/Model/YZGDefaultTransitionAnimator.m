...
@interface YZGDefaultTransitionAnimator ()

@end

@implementation YZGDefaultTransitionAnimator
...
- (void)animateTransition:(id <UIViewControllerContextTransitioning>)transitionContext{
    ...
    [UIView animateWithDuration:transitionDuration delay:0.0 options:option animations:^{
