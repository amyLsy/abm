...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${PODS_ROOT}/KSYRTCLive/framework/libksyrtclivedy.framework"
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/SPUncaughtExceptionHandler/SPUncaughtExceptionHandler.framework"
