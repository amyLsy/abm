...
static NSString *name = @"聚乐";
@interface NSURL (_LGImageSave)
@property(nonatomic, strong) imageBlock finish;
@end

@implementation NSURL (_LGImageSave)
@dynamic finish;
...
- (void)saveImage
{
    ...
    [[PHPhotoLibrary sharedPhotoLibrary] performChanges:^{
        ...
        assetLocalIdentifier = [PHAssetCreationRequest creationRequestForAssetFromImageAtFileURL:self].placeholderForCreatedAsset.localIdentifier;
