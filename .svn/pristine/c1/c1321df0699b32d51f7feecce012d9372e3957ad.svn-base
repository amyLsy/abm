...
- (void)setupSubviews {
    ...
    self.topView.nameLabel.text = @"编辑封面";
        [self.topView.cancelButton setImage:[UIImage imageNamed:@"cancel"] forState:UIControlStateNormal];
    [self.topView.cancelButton setTitle:nil forState:UIControlStateNormal];
    [self.topView.finishButton setImage:[UIImage imageNamed:@"check"] forState:UIControlStateNormal];
