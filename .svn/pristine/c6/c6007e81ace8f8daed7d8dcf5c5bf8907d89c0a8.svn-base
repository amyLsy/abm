...
//    //加上电池栏的高度
//    self.navBar.height += 20;
//    //添加navItem这样才能显示我们的控制器标题
//    self.navBar.items = @[self.navItem];
////    0xF6F6F6
//    self.navBar.barTintColor =rgba(1, 1, 1, 1);
//    //navBar背景颜色
//    self.navBar.titleTextAttributes = @{NSForegroundColorAttributeName:rgba(37, 37, 37, 1)};
...
//    self.tableView.contentInset = UIEdgeInsetsMake(self.navBar.height, 0, LGtabBarH + LGstatusBarH, 0);
